 ...
 */
class EventTables extends \Entities\EventTables implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\EventTables' . "\0" . 'id', '' . "\0" . 'Entities\\EventTables' . "\0" . 'eventId', '' . "\0" . 'Entities\\EventTables' . "\0" . 'tableId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventTables $proxy) {
