 ...
 * MembersInfo
 *
 * @ORM\Table(name="members_info", uniqueConstraints={@ORM\UniqueConstraint(name="member_id", columns={"member_id"})}, indexes={@ORM\Index(name="member_id_2", columns={"member_id"}), @ORM\Index(name="member_id_3", columns={"member_id"}), @ORM\Index(name="member_id_4", columns={"member_id"}), @ORM\Index(name="id", columns={"id"}), @ORM\Index(name="email", columns={"email"}), @ORM\Index(name="email_2", columns={"email"})})
 * @ORM\Entity
 */
class MembersInfo
{
