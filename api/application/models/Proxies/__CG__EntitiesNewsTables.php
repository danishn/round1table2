 ...
 */
class NewsTables extends \Entities\NewsTables implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\NewsTables' . "\0" . 'id', '' . "\0" . 'Entities\\NewsTables' . "\0" . 'newsId', '' . "\0" . 'Entities\\NewsTables' . "\0" . 'tableId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NewsTables $proxy) {
