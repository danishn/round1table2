...
class Members extends \Entities\Members implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Members' . "\0" . 'memberId', '' . "\0" . 'Entities\\Members' . "\0" . 'tableId', '' . "\0" . 'Entities\\Members' . "\0" . 'password', '' . "\0" . 'Entities\\Members' . "\0" . 'registrationDate', '' . "\0" . 'Entities\\Members' . "\0" . 'lastVisitDate', '' . "\0" . 'Entities\\Members' . "\0" . 'memberType', '' . "\0" . 'Entities\\Members' . "\0" . 'status', '' . "\0" . 'Entities\\Members' . "\0" . 'email', '' . "\0" . 'Entities\\Members' . "\0" . 'gcmId', '' . "\0" . 'Entities\\Members' . "\0" . 'apnId', '' . "\0" . 'Entities\\Members' . "\0" . 'otp', '' . "\0" . 'Entities\\Members' . "\0" . 'designation');
        }
