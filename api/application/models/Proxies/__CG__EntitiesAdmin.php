...
class Admin extends \Entities\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\Admin' . "\0" . 'adminId', '' . "\0" . 'Entities\\Admin' . "\0" . 'name', '' . "\0" . 'Entities\\Admin' . "\0" . 'email', '' . "\0" . 'Entities\\Admin' . "\0" . 'password', '' . "\0" . 'Entities\\Admin' . "\0" . 'lastLogin', '' . "\0" . 'Entities\\Admin' . "\0" . 'dateCreated');
        }
